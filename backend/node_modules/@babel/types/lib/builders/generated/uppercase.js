...
const ArrayExpression = exports.ArrayExpression = alias("arrayExpression"),
  ...
  JSXAttribute = exports.jsAttribute = alias("jsxAttribute"),
  JSXClosingElement = exports.jsClosingElement = alias("jsxClosingElement"),
  JSXElement = exports.jsElement = alias("jsxElement"),
  JSXEmptyExpression = exports.jsEmptyExpression = alias("jsxEmptyExpression"),
  JSXExpressionContainer = exports.jsExpressionContainer = alias("jsxExpressionContainer"),
  JSXSpreadChild = exports.jsSpreadChild = alias("jsxSpreadChild"),
  JSXIdentifier = exports.jsIdentifier = alias("jsxIdentifier"),
  JSXMemberExpression = exports.jsMemberExpression = alias("jsxMemberExpression"),
  JSXNamespacedName = exports.jsNamespacedName = alias("jsxNamespacedName"),
  JSXOpeningElement = exports.jsOpeningElement = alias("jsxOpeningElement"),
  JSXSpreadAttribute = exports.jsSpreadAttribute = alias("jsxSpreadAttribute"),
  JSXText = exports.jsText = alias("jsxText"),
  JSXFragment = exports.jsFragment = alias("jsxFragment"),
  JSXOpeningFragment = exports.jsOpeningFragment = alias("jsxOpeningFragment"),
  JSXClosingFragment = exports.jsClosingFragment = alias("jsxClosingFragment"),
