...
export class Scope {
    ...
    globals: { [name: string]: t.Identifier | t.jsIdentifier };
    ...
    addGlobal(node: t.Identifier | t.jsIdentifier): void;
...
export class NodePath<T = Node> {
    ...
    isJSX(opts?: object): this is NodePath<t.js>;
    isJSXAttribute(opts?: object): this is NodePath<t.jsAttribute>;
    isJSXClosingElement(opts?: object): this is NodePath<t.jsClosingElement>;
    isJSXClosingFragment(opts?: object): this is NodePath<t.jsClosingFragment>;
    isJSXElement(opts?: object): this is NodePath<t.jsElement>;
    isJSXEmptyExpression(opts?: object): this is NodePath<t.jsEmptyExpression>;
    isJSXExpressionContainer(opts?: object): this is NodePath<t.jsExpressionContainer>;
    isJSXFragment(opts?: object): this is NodePath<t.jsFragment>;
    isJSXIdentifier(opts?: object): this is NodePath<t.jsIdentifier>;
    isJSXMemberExpression(opts?: object): this is NodePath<t.jsMemberExpression>;
    isJSXNamespacedName(opts?: object): this is NodePath<t.jsNamespacedName>;
    isJSXOpeningElement(opts?: object): this is NodePath<t.jsOpeningElement>;
    isJSXOpeningFragment(opts?: object): this is NodePath<t.jsOpeningFragment>;
    isJSXSpreadAttribute(opts?: object): this is NodePath<t.jsSpreadAttribute>;
    isJSXSpreadChild(opts?: object): this is NodePath<t.jsSpreadChild>;
    isJSXText(opts?: object): this is NodePath<t.jsText>;
    ...
    assertJSX(opts?: object): asserts this is NodePath<t.js>;
    assertJSXAttribute(opts?: object): asserts this is NodePath<t.jsAttribute>;
    assertJSXClosingElement(opts?: object): asserts this is NodePath<t.jsClosingElement>;
    assertJSXClosingFragment(opts?: object): asserts this is NodePath<t.jsClosingFragment>;
    assertJSXElement(opts?: object): asserts this is NodePath<t.jsElement>;
    assertJSXEmptyExpression(opts?: object): asserts this is NodePath<t.jsEmptyExpression>;
    assertJSXExpressionContainer(opts?: object): asserts this is NodePath<t.jsExpressionContainer>;
    assertJSXFragment(opts?: object): asserts this is NodePath<t.jsFragment>;
    assertJSXIdentifier(opts?: object): asserts this is NodePath<t.jsIdentifier>;
    assertJSXMemberExpression(opts?: object): asserts this is NodePath<t.jsMemberExpression>;
    assertJSXNamespacedName(opts?: object): asserts this is NodePath<t.jsNamespacedName>;
    assertJSXOpeningElement(opts?: object): asserts this is NodePath<t.jsOpeningElement>;
    assertJSXOpeningFragment(opts?: object): asserts this is NodePath<t.jsOpeningFragment>;
    assertJSXSpreadAttribute(opts?: object): asserts this is NodePath<t.jsSpreadAttribute>;
    assertJSXSpreadChild(opts?: object): asserts this is NodePath<t.jsSpreadChild>;
    assertJSXText(opts?: object): asserts this is NodePath<t.jsText>;
...
export interface VirtualTypeAliases {
    ...
    Pure: Node;
    Referenced: Node;
    ReferencedIdentifier: t.Identifier | t.jsIdentifier;
