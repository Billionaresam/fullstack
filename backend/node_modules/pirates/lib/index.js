...
function addHook(hook, opts = {}) {
  ...
  // We need to do this to fix #15. Basically, if you use a non-standard extension (ie. .js), then
  // We modify the .js loader, then use the modified .js loader for as the base for .js.
  // This prevents that.
